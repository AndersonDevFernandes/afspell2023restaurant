...
function abrirModal14(){
  const modal = document.getElementById('janela-modal14')
  modal.classList.add('abrir')

  modal.addEventListener('click', (e) => {
    if(e.target.id == 'fechar' || e.target.id == 'janela-modal14'){
      modal.classList.remove('abrir')
    }
  })
}
function abrirModal15(){
  const modal = document.getElementById('janela-modal15')
  modal.classList.add('abrir')

  modal.addEventListener('click', (e) => {
    if(e.target.id == 'fechar' || e.target.id == 'janela-modal15'){
      modal.classList.remove('abrir')
    }
  })
}
...
function abrirModal001(){
  const modal = document.getElementById('janela-modal001')
  modal.classList.add('abrir')

  modal.addEventListener('click', (e) => {
    if(e.target.id == 'fechar' || e.target.id == 'janela-modal001'){
      modal.classList.remove('abrir')
    }
  })
}